...
# Obtenir l'indice du fichier à traiter
index=$SLURM_ARRAY_TASK_ID

# Obtenir le nom des fichiers à partir de l'indice
file1="${files[$index]}_R1.fastq.gz"
file2="${files[$index]}_R2.fastq.gz"

# Vérifier si les fichiers existent avant de lancer FastQC
